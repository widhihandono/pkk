...
//                        crudPkk.getData_pkk_catatan_keluarga_detail("1801214609890001").get(0).getSandang(),Toast.LENGTH_LONG).show();
        if(crudPkk.getData_pkk_catatan_keluarga_detail(nik).get(0).getBerkebutuhan_khusus().equals("1"))
        {
            holder.cbListCatatan.setChecked(true);
        }
        else if(crudPkk.getData_pkk_catatan_keluarga_detail(nik).get(0).getPenghayatan_dan_pengamalan_pancasila().equals("1"))
        {
            holder.cbListCatatan.setChecked(true);
        }
        else if(crudPkk.getData_pkk_catatan_keluarga_detail(nik).get(0).getGotong_royong().equals("1"))
        {
            holder.cbListCatatan.setChecked(true);
        }
        else if(crudPkk.getData_pkk_catatan_keluarga_detail(nik).get(0).getPendidikan_ketrampilan().equals("1"))
        {
            holder.cbListCatatan.setChecked(true);
        }
        else if(crudPkk.getData_pkk_catatan_keluarga_detail(nik).get(0).getPengembangan_kehidupan_berkoperasi().equals("1"))
        {
            holder.cbListCatatan.setChecked(true);
        }
        else if(crudPkk.getData_pkk_catatan_keluarga_detail(nik).get(0).getPangan().equals("1"))
        {
            holder.cbListCatatan.setChecked(true);
        }
        else if(crudPkk.getData_pkk_catatan_keluarga_detail(nik).get(0).getSandang().equals("1"))
        {
            holder.cbListCatatan.setChecked(true);
        }
        else if(crudPkk.getData_pkk_catatan_keluarga_detail(nik).get(0).getKesehatan().equals("1"))
        {
            holder.cbListCatatan.setChecked(true);
        }
        else if(crudPkk.getData_pkk_catatan_keluarga_detail(nik).get(0).getPerencanaan_sehat().equals("1"))
        {
            holder.cbListCatatan.setChecked(true);
        }
        else if(crudPkk.getData_pkk_catatan_keluarga_detail(nik).get(0).getId_kelompok_umur().equals("1"))
        {
            holder.cbListCatatan.setChecked(true);
        }
